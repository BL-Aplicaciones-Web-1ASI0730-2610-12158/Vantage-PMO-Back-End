...
namespace vantagePMO_platform.Shared.Infrastructure.Persistence.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260707031525_AddResourcePlanningSchema")]
    partial class AddResourcePlanningSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vantagePMO_platform.ResourcePlanning.Domain.Model.Aggregates.ResourcePlanningDashboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("CapacityGaps")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("capacity_gaps");

                    b.Property<string>("DepartmentCapacity")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("department_capacity");
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_resource_plannings");

                    b.ToTable("resource_plannings", (string)null);
                });

            modelBuilder.Entity("vantagePMO_platform.RiskCompliance.Domain.Model.Aggregates.ComplianceMetrics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DocCompliance")
                        .HasColumnType("int")
                        .HasColumnName("doc_compliance");

                    b.Property<double>("IntegrityDelta")
                        .HasColumnType("double")
                        .HasColumnName("integrity_delta");

                    b.Property<double>("IntegrityPulse")
                        .HasColumnType("double")
                        .HasColumnName("integrity_pulse");

                    b.Property<int>("SlaCompliance")
                        .HasColumnType("int")
                        .HasColumnName("sla_compliance");

                    b.Property<string>("SystemIntegrityAlerts")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("system_integrity_alerts");

                    b.HasKey("Id")
                        .HasName("p_k_compliance_metrics");

                    b.ToTable("compliance_metrics", (string)null);
                });

            modelBuilder.Entity("vantagePMO_platform.RiskCompliance.Domain.Model.Aggregates.RiskItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ControlLog")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("control_log");
                    ...
                    b.Property<bool>("HasActionPlan")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("has_action_plan");
            ...
            modelBuilder.Entity("vantagePMO_platform.RiskCompliance.Domain.Model.Aggregates.RiskMatrix", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("HeatmapCells")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("heatmap_cells");
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_risk_matrices");

                    b.ToTable("risk_matrices", (string)null);
                });

            modelBuilder.Entity("vantagePMO_platform.Schedule.Domain.Model.Aggregates.ScheduleEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_user_schedule_entries");

                    b.HasIndex("Active")
                        .HasDatabaseName("i_x_user_schedule_entries_active");

                    b.HasIndex("UserId")
                        .HasDatabaseName("i_x_user_schedule_entries_user_id");

                    b.HasIndex("UserId", "Date")
                        .HasDatabaseName("i_x_user_schedule_entries_user_id_date");

                    b.ToTable("user_schedule_entries", (string)null);
                });
